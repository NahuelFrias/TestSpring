...
import com.example.nahuel.test.springboot.app.repositories.BancoRepository;
...
public class CuentaServiceImpl implements CuentaService{
    ...
    public Cuenta findById(Long id) {
        //puede usarse un Optional con isPresent
